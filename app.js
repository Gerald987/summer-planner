...
const DEFAULT_TASKS = {
  physics: [
    'Watch 1 topic explainer video on YouTube (15min)',
    'Make 5 formula flashcards from a past paper mark scheme',
    'Do 5 multiple-choice questions from Paper 1',
    'Explain one physics concept out loud to yourself',
    'Sketch a diagram of an experiment you studied',
    'Do 2 calculation questions from a past Paper 2',
    'Read one section of the textbook summary box',
    'Quiz yourself on definitions (speed, velocity, acceleration)',
  ],
  design: [
    'Browse Behance/Dribbble for 10min of design inspiration',
    'Try one new tool in Photoshop for 15min',
    'Redraw a logo in a different style (15min sketch)',
    'Save 3 designs you like and note what works',
    'Watch a 10min typography basics tutorial',
    'Free-write a design brief for a fake client',
  ],
  engineering: [
    'Watch a 10min CAD tutorial video',
    'Sketch a simple object in isometric view',
    'Read one page from an engineering textbook',
    'Research one material property online (5min)',
    'Take apart an old pen and sketch its mechanism',
    'Look at 2 D-grade exemplar reports (just read, don\'t write)',
  ],
  maths: [
    'Do 5 algebra practice questions from a past paper',
    'Write out one formula you keep forgetting 5 times',
    'Watch a 10min stats/probability recap video',
    'Do 3 trigonometry questions without a calculator',
    'Teach one maths concept to an imaginary friend',
    'Complete 1 section of a non-calculator paper',
  ],
  multimedia: [
    'Watch a 5min editing technique tutorial',
    'Trim and export a 30-second clip of anything',
    'Write down 3 ideas for a short video project',
    'Browse professional multimedia work for 10min',
    'Record a 1min voice memo about a film you like',
  ],
};
